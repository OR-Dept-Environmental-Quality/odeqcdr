...
#'
#' Export monitoring results into the most recent version of Oregon DEQ's continuous data submission template xlsx file format version 2.03.
...
contin_export_v2 <- function(file, org, projects, mloc, deployment, results, prepost, audits, sumstats=NULL) {
  ...
  deployment <- deployment[, odeqcdr::cols_deploy(ver=2)]
