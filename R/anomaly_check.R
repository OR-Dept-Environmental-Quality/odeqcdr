...
#' if the strahler stream order is not known. If a result is flagged as an anomaly it
#' should be closely reviewed.  The 10th and 90th percentiles were calculated from all
