...
#' Use odeqcdr::import_contin() to get the list that hold the data frames used for this function's inputs.
#'
...
#'
#' @param prepost Data frame of the prepost data generated using odeqcdr::import_contin().
