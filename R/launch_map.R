    ...
    map <- leaflet::leaflet() %>%
      ...
      leaflet.esri::addEsriFeatureLayer(url = "https://arcgis.deq.state.or.us/arcgis/rest/services/WQ/NHDH_ORDEQ/MapServer/1",
                                        ...
                                        highlightOptions = highlightOptions(color="black",
                                                                            ...
                                                                            bringToFront = TRUE,
                                                                            sendToBack = TRUE),
                                        popupProperty = JS("function(feature){var props = feature.properties; return props.mloc_uid+\", \"+props.MonLocType+ \" \"+props.StationDes+\" \"}")
      ) %>%
      leaflet.esri::addEsriFeatureLayer(url = "https://arcgis.deq.state.or.us/arcgis/rest/services/WQ/AWQMS_Stations/MapServer/1",
                                        ...
                                        markerOptions = leaflet::markerOptions(pane = "Points",
                                                                               riseOnHover = TRUE),
                                        labelProperty = JS("function(feature){var props = feature.properties; return props.mloc_uid+\", \"+props.MonLocType+ \" \"+props.StationDes+\" \"}"),
                                        popupProperty = JS("function(feature){var props = feature.properties; return props.mloc_uid+\", \"+props.MonLocType+ \" \"+props.StationDes+\" \"}")
      )
    map <- map %>%
